...
const Auth0ProviderWithHistory = ({ children }) => {
  ...
  return (
    <Auth0Provider domain={domain} clientId={clientId} redirectUri="https://food4all-front.herokuapp.com/" onRedirectCallback="""https://food4all-front.herokuapp.com/search" audience={audience}>
      {children}
    </Auth0Provider>
  );
};
